...
// Contrôle du token de sécurité
if(!array_key_exists('HTTP_APPTOKEN', $_SERVER)){
	exit('{"error" : "security token is missing"');
}
if($_SERVER['HTTP_APPTOKEN'] != 'xxxxx'){
	exit('{"error" : "bad security token"');
}

// Database connexion
$dsn = 'mysql://user:pass@ip:port/inr_traker/';
